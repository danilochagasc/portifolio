...
const TEXTS: { pt: HeroTexts; en: HeroTexts } = {
  pt: {
    ...
    description: 'Engenheiro de Software com foco em Backend e experiência em desenvolvimento Frontend. Atualmente trabalho com sistemas de pagamento de alta escala no iFood, processando mais de 6 milhões de transações por dia. Mestrando em Ciência da Computação na UFLA.',
    cta: 'Ver Projetos',
  ...
  en: {
    ...
    description: 'Software Engineer focused on Backend with experience in Frontend development. Currently working on large-scale payment systems at iFood, processing over 6 million transactions per day. M.Sc. student in Computer Science at UFLA.',
    cta: 'View Projects',
