...
const TEXTS: { pt: HeroTexts; en: HeroTexts } = {
  pt: {
    ...
    description: 'Especialista em Backend com experiência em sistemas de alta escala. Atualmente construindo soluções robustas no iFood.',
    cta: 'Ver Projetos',
  ...
  en: {
    ...
    description: 'Backend specialist with experience in high-scale systems. Currently building robust solutions at iFood.',
    cta: 'View Projects',
