...
\entry{Emakers Jr}{\faCalendar \space Jun/2023 -- Abr/2025}{Desenvolvedor Backend}{\faMapMarker \space Lavras - MG}
\space
\vspace{-1.6em}
\begin{itemize}
\setlength\itemsep{0em}
\item Desenvolvi e mantive o backend do sistema Redação Inteligente, plataforma de gestão de cursos e correção de redações com milhares de usuários ativos.
